        ...
        <Container
          ...
          <Stack spacing={{ base: 10, md: 20 }}>
            <Heading
              ...
              engajados na luta contra a poluição
            </Heading>
                ...
                {avatars.map((avatar) => (
                  <Avatar
                    ...
                    _before={{
                      ...
                      bgGradient: 'linear(to-bl, green.400,green.900)',
                      position: 'absolute',
                      zIndex: -1,
                      top: 0,
                      left: 0,
          ...
          <Stack
            ...
            <Stack spacing={4}>
              ...
              <Text color={'gray.500'} fontSize={{ base: 'sm', sm: 'md' }}>
                Se você é engajado na luta da preservação da natureza, faça parte do E-coleta!
              </Text>
            </Stack>
            <Box as={'form'} mt={10}>
              <Stack spacing={4}>
